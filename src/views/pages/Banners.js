...
const Banners = () => {
  ...
  useEffect(() => {
    async function getData() {
      await axios.get('http://18.217.43.19:3000/banners/all').then(res => {
        setData(res.data);
  ...
  async function submitForm() {
    ...
    axios
      .all([
        axios.post('http://18.217.43.19:3000/photos/upload', formData),
    ...
    <div>
      ...
      <Modal isOpen={pics} toggle={picsClose} style={{ width: 800, height: 500 }}>
        ...
        <ModalBody style={{ alignSelf: 'center' }}>
          <img style={{ padding: 10 }} src={'http://18.217.43.19/uploads/' + urlPic} />
        </ModalBody>
        <ModalFooter>
